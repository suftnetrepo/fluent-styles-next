...
const Badge = ({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_fluentStyles.Stack, {
    ...
    children: isDot ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_fluentStyles.Stack, {
      width: 6,
      height: 6,
      borderRadius: 3,
...
function getVariantChipProps(variant, isActive, colors) {
...
function TabBarInner(props) {
  ...
  const navigateTo = (0, _react.useCallback)(idx => {
    ...
    const iw = indicatorWidth === undefined ? indicator === 'pill' ? layout.tab.width : layout.text.width : indicatorWidth === 0 ? layout.tab.width : indicatorWidth;
    ...
    if (tabAlign === 'scroll') {
      scrollRef.current?.scrollTo({
        x: layout.tab.x + layout.tab.width / 2 - barWidthRef.current / 2,
        animated: true
      });
    }
  ...
  const renderTab = (item, index) => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_fluentStyles.StyledPressable, {
      ...
      children: [item.iconRender?.(isActive ? resolvedActiveTextColor : resolvedTextColor, isActive), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_fluentStyles.Stack, {
        position: "relative",
        alignItems: "center",
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_fluentStyles.Stack, {
    ...
    ...borderProps,
    ...style,
    children: tabAlign === 'center' ? /*#__PURE__*/(0, _jsxRuntime.jsxs)(_fluentStyles.Stack, {
      flex: 1,
      flexDirection: "row",
      alignItems: "center",
      position: "relative",
      ...contentStyle,
      children: [indicatorEl, options.map(renderTab)]
