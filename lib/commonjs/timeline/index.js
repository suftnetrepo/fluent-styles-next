...
const StyledTimeline = ({
  ...
  const F = {
    startFontSize: fontsProp?.startFontSize ?? _fluentStyles.theme.fontSize.normal,
    endFontSize: fontsProp?.endFontSize ?? _fluentStyles.theme.fontSize.small,
    startFontWeight: fontsProp?.startFontWeight ?? _fluentStyles.theme.fontWeight.normal,
    endFontWeight: fontsProp?.endFontWeight ?? _fluentStyles.theme.fontWeight.normal
  };
