...
export function headerPadStyle(size) {
...
export function bodyPadStyle(size) {
  const p = PADDING[size];
  return {
    paddingHorizontal: p.h,
    paddingVertical: p.v
...
export function titleTextStyle(size, color) {
  return {
    fontSize: FONT_SIZE[size].title,
    color
  };
}
export function subtitleTextStyle(size, color) {
  return {
