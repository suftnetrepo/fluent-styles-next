...
import { COLLAPSE_DARK, COLLAPSE_LIGHT } from "./interface.js";
import { S, headerPadStyle, bodyPadStyle, titleTextStyle, subtitleTextStyle } from "./style.js";
...
function getRootStyle(variant, square, colors) {
  switch (variant) {
    case 'card':
      return [S.root_card, square && S.root_card_square, {
...
const Collapse = ({
  ...
  const baseColors = resolveTheme('system', deviceScheme) === 'light' ? COLLAPSE_LIGHT : COLLAPSE_DARK;
  ...
  const runAnimation = useCallback((toOpen, immediate) => {
    animRef.current?.stop();
    const targetH = toOpen ? bodyHeight.current : 0;
    const dur = immediate ? 0 : duration;
    animRef.current = Animated.parallel([Animated.timing(heightAnim, {
      toValue: targetH,
      duration: dur,
  ...
  const chevronNode = hideIcon ? null : /*#__PURE__*/_jsx(AnimatedChevron, {
    rotate: chevronAnim,
    color: resolvedIconColor,
    size: iconSize,
    style: iconStyle
  });
  const headerRightNode = renderHeaderRight ? renderHeaderRight(open, chevronNode) : /*#__PURE__*/_jsxs(_Fragment, {
    children: [trailing ? /*#__PURE__*/_jsx(View, {
      style: S.trailing,
      children: trailing
    }) : null, chevronNode]
  });
  ...
  const headerContent = renderHeader ? renderHeader(open) : /*#__PURE__*/_jsxs(View, {
    style: [S.header, hPad, open && activeHeader && {
  ...
  const bodyNode = /*#__PURE__*/_jsx(Animated.View, {
    style: [S.body_animated, {
      height: heightAnim
    }],
    children: /*#__PURE__*/_jsxs(View, {
      ...
      }), showBodyDivider && /*#__PURE__*/_jsx(View, {
        style: [S.body_divider, {
  ...
  return /*#__PURE__*/_jsxs(View, {
    ...
    }), showHeaderDivider && /*#__PURE__*/_jsx(View, {
      style: [S.divider, {
        backgroundColor: colors.divider
      }]
    }), bodyNode]
