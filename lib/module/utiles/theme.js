 ...
 */
export function resolveTheme(theme, deviceScheme) {
...
export const NOTIFICATION_DARK = {
  background: '#18181b',
  border: '#3f3f46',
  source: '#71717a',
  title: '#f4f4f5',
...
export const NOTIFICATION_LIGHT = {
  background: '#ffffff',
  border: '#e5e5ea',
  source: '#8e8e93',
  title: '#1c1c1e',
