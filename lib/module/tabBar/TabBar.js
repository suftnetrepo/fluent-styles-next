...
const Badge = ({
  ...
  return /*#__PURE__*/_jsx(Stack, {
    ...
    children: isDot ? /*#__PURE__*/_jsx(Stack, {
      width: 6,
      height: 6,
      borderRadius: 3,
...
function TabBarInner(props) {
  ...
  const renderTab = (item, index) => {
    ...
    return /*#__PURE__*/_jsxs(StyledPressable, {
      ...
      children: [item.iconRender?.(isActive ? resolvedActiveTextColor : resolvedTextColor, isActive), /*#__PURE__*/_jsxs(Stack, {
        position: "relative",
        alignItems: "center",
  ...
  return /*#__PURE__*/_jsx(Stack, {
    ...
    ...borderProps,
    ...style,
    children: tabAlign === 'center' ? /*#__PURE__*/_jsxs(Stack, {
      flex: 1,
      flexDirection: "row",
      alignItems: "center",
      position: "relative",
