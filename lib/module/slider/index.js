...
export const StyledSlider = ({
  ...
  const prevHighRef = useRef(undefined);
  useEffect(() => {
  ...
  const handleLowMove = useCallback(frac => {
  ...
  const handleHighMove = useCallback(frac => {
  ...
  return /*#__PURE__*/_jsxs(View, {
    ...
    children: [/*#__PURE__*/_jsxs(View, {
      ...
      children: [/*#__PURE__*/_jsxs(View, {
        ...
        children: [variant === "buffer" && /*#__PURE__*/_jsx(View, {
          style: {
            position: "absolute",
            left: 0,
            top: 0,
        ...
        }), variant === "range" ? /*#__PURE__*/_jsx(View, {
          style: {
            position: "absolute",
            left: `${lowF * 100}%`,
        ...
        }) : variant === "gradient" ? /*#__PURE__*/_jsx(GradFill, {
          width: barW,
          height: trackH,
          fillFraction: lowF,
          gradFrom: C.gradFrom,
      ...
      }), variant === "stepped" && tickPositions.map((t, i) => /*#__PURE__*/_jsx(View, {
        style: {
          position: "absolute",
          left: t * barW - 1,
        ...
        onEnd: handleLowEnd
      }), variant === "range" && /*#__PURE__*/_jsx(Thumb, {
        position: highF,
        trackWidth: barW,
        thumbD: thumbD,
        trackH: trackH,
    ...
    }), showMinMax && /*#__PURE__*/_jsxs(Stack, {
      horizontal: true,
