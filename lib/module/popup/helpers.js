...
export function resolveAnimation(animation, position) {
...
export function hiddenValue(animation, position) {
...
export function visibleValue(animation) {
...
export function animatedStyle(animation, position, value // Animated.Value
) {
  switch (animation) {
    case 'fade':
      return {
...
export function getBorderRadius(position, round, radius) {
